...
const SVGpart01 = `<svg className="rounded-full" xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' viewBox='0 0 2500 2500'><defs>
    ...
    setSVG01(
      SVGpart01.replaceAll("body", "body01c")
        ...
        SVGpart03.replaceAll("body", "body01c")
          ...
          .replaceAll("pupils", "pupils01c")
          .replaceAll("gills", "gills01c") +
        clothingTraits[Math.floor(Math.random() * clothingTraits.length)] +
